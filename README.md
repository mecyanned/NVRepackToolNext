# NVIDIA Driver Repack Tool Next
 ...
 1. Install [AutoHotkey](https://www.autohotkey.com/download/ahk-v2.exe) and download [this repository](https://github.com/mecyanned/NVRepackToolNext/archive/refs/heads/main.zip).
